...
const {
	applications
} = require('../server/seed/Application.json');
const {
	jobSkills
} = require('../server/seed/JobSkill.json');
...
describe('All json file should have data', () => {
	...
	describe('Skill.json', () => {
		...
		test('should have the correct data for the following property', () => {
			expect(skills[1]).toHaveProperty(
				'name',
				'JavaScript'
			);
